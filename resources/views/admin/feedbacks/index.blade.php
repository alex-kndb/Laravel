            ...
            <table class="table table-bordered">
                ...
                @forelse ($feedbacks as $feedback)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.feedbacks.edit', ['feedback' => $feedback]) }}" style="color:blue">Изм.</a> &nbsp;
                            <a href="javascript:" class="delete" rel="{{ $feedback->id }}" style="color:red">Уд.</a>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="6">Отзывов нет</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            elements.forEach(function(item) {
                item.addEventListener("click", function() {
                    ...
                    if(confirm(`Вы действительно хотите удалить отзыв? (#ID = ${id})`)) {
